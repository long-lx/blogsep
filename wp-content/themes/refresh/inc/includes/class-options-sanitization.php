...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'refresh' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'refresh' ),
		'repeat-y'  => __( 'Repeat Vertically', 'refresh' ),
		'repeat'    => __( 'Repeat All', 'refresh' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'refresh' ),
		'top center'    => __( 'Top Center', 'refresh' ),
		'top right'     => __( 'Top Right', 'refresh' ),
		'center left'   => __( 'Middle Left', 'refresh' ),
		'center center' => __( 'Middle Center', 'refresh' ),
		'center right'  => __( 'Middle Right', 'refresh' ),
		'bottom left'   => __( 'Bottom Left', 'refresh' ),
		'bottom center' => __( 'Bottom Center', 'refresh' ),
		'bottom right'  => __( 'Bottom Right', 'refresh')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'refresh' ),
		'fixed'  => __( 'Fixed in Place', 'refresh')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'refresh' ),
		'italic'      => __( 'Italic', 'refresh' ),
		'bold'        => __( 'Bold', 'refresh' ),
		'bold italic' => __( 'Bold Italic', 'refresh' )
		);
